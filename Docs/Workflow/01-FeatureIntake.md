...
Use this step for user-visible features, UI behavior changes, playback/source/search/download/persistence changes, and bug fixes that change what users can observe.
...
1. Compare the request with the current product surface.
   ...
   - Inspect the owning views, view models, use cases, repositories, stores, or system integration files.
2. Write a short requirement analysis in the working notes.
   - User problem.
   - Current behavior.
   - Required behavior.
   - Relevant macOS constraints, such as window size, focus, keyboard shortcuts, playback surface, downloads, or persistence.
...
- A formal acceptance checklist exists when the change needs real macOS click-through validation.
